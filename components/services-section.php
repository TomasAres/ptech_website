      ...
      <div class="row">
         ...
         <div class="col-md-6 column-services">
            ...
            <div class="service top-xl">
               <div class="service-header d-inline d-flex align-items-center">
                  <img src="img/data_icon.svg" alt="Software development icon" class="service-logo" height="27" />
            ...
            <div class="service top-xl">
               <div class="service-header d-inline d-flex align-items-center">
                  <img src="img/geo_icon.svg" alt="Software development icon" class="service-logo" height="27" />
            ...
            <div class="service top-xl">
               <div class="service-header d-inline d-flex align-items-center">
                  <img src="img/elearning_icon.svg" alt="Software development icon" class="service-logo" height="27" />
