	...
	<body id="pams-platform" class="case-study-page">
		...
		<main>
			<?php 
                ...
                $serviceName="PAMS, a digital platform for efficiency and transparency";
                $heroTitle="PAMS, a digital platform for efficiency and transparency";
                $heroBody="Transparency improves efficiency by identifying bottlenecks, minimizing wastefulness, and maximizing the impact of spent resources. PAMS brings more transparency to your projects by providing a safe digital environment to share critical information.";
                $mainTitle="Centralized data management system";
                ...
                $titleOne='Clients';
                $contentOne='Olam, Blommer, Thabico, Dole, and more';
                $titleTwo='Service';
